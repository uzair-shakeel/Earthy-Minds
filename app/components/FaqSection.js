...
const FaqSection = () => {
  ...
  return (
    <div id="faq" className="scroll-mt-28 sm:scroll-mt-44 max-w-[872px] w-full mx-auto my-10 md:mt-[94px] md:mb-[99px] md:bg-[#B3853E4A]/30 md:border border-[#B3853E] md:p-8 rounded-[10px]">
